                ...
                {transactions.map((txn, i) => {
                  ...
                  return (
                    <tr key={txn.transaction_id ?? i}>
                      ...
                      <td className="border border-[#333] text-center" style={{ padding: "clamp(2px,0.4vw,5px) clamp(2px,0.3vw,4px)", height: "clamp(18px,2.5vw,28px)" }}>{txn.Cond_I || ""}</td>
                      ...
                      <td className="border border-[#333] text-center" style={{ padding: "clamp(2px,0.4vw,5px) clamp(2px,0.3vw,4px)", height: "clamp(18px,2.5vw,28px)" }}>{fmt(txn.I_Bags)}</td>
                      <td className="border border-[#333] text-center" style={{ padding: "clamp(2px,0.4vw,5px) clamp(2px,0.3vw,4px)", height: "clamp(18px,2.5vw,28px)" }}>{fmt(txn.I_GKG)}</td>
                      <td className="border border-[#333] text-center" style={{ padding: "clamp(2px,0.4vw,5px) clamp(2px,0.3vw,4px)", height: "clamp(18px,2.5vw,28px)" }}>{fmt(txn.I_NKG)}</td>
                    </tr>
                  );
                })}
